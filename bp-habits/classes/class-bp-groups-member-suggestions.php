 ...
 * @since BuddyPress 2.1.0
 */
class bgci_bp_habits_Member_Suggestions extends BP_Members_Suggestions {
	...
	public function validate() {
		 ...
		 * @param bgci_bp_habits_Member_Suggestions $this  Instance of the current suggestion class.
		 */
		$this->args = apply_filters( 'bgci_bp_habits_member_suggestions_args', $this->args, $this );
		 ...
		 * @param bgci_bp_habits_Member_Suggestions $this  Instance of the current suggestion class.
		 */
		return apply_filters( 'bgci_bp_habits_member_suggestions_validate_args', parent::validate(), $this );
	}
	...
	public function get_suggestions() {
		 ...
		 * @param bgci_bp_habits_Member_Suggestions $this       Instance of the current suggestion class.
		 */
		$user_query = apply_filters( 'bgci_bp_habits_member_suggestions_query_args', $user_query, $this );
		 ...
		 * @param bgci_bp_habits_Member_Suggestions $this    Instance of the current suggestion class.
		 */
		return apply_filters( 'bgci_bp_habits_member_suggestions_get_suggestions', $results, $this );
	}
}
